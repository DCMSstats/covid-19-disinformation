...
.. code-block:: bash
  ...
  python3 scrape_reddit.py -t cats  -c 5

  python3 scrape_reddit.py -t cats -c 5 -csv /file_path -n my_csv

  python3 scrape_reddit.py -t cats -c 5 -gbq my_project_id -n my_gbq

  python3 scrape_reddit.py -t cats -c 5 -csv /file_path -n my_csv -s hot
